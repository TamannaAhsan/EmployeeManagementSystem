...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<UserDTO> create (@RequestBody UserDTO userDTO) throws ApiSystemException, ApiNotAcceptableException {

        Utility.checkIfUserIsAdmin();

        UserDTO savedUserDTO = userService.createEmployeeByAdmin(userDTO);
